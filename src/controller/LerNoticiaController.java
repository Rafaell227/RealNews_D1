...
public class LerNoticiaController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("VerNoticia.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(comentarioService.adicionarComentario(comentario)) {
			...
			saida.println("<h2>Comentário preenchido de forma incorreta !</h2>");
			saida.println("<a href='LerNoticia.do?id=" + idNoticia + "'>Retornar</a>");
		}	
	}
}
